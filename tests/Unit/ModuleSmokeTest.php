...
final class ModuleSmokeTest extends TestCase
{
    ...
    public function testWebhooksClientExposesAppointmentHelpers(): void
    {
        ...
        $this->assertTrue(method_exists(Webhooks_client::class, 'get_appointment_diff_fields'));
        $this->assertNotFalse($source);
        ...
        $this->assertStringContainsString('meeting_link', $source);
        $this->assertStringContainsString('id_zoom_meeting', $source);
    }
