...
$lang['google_diagnose_unavailabilities_hint'] = 'Export unavailability rows and duplicate groups for this provider (JSON).';
...
$lang['google_reset_unavailabilities_hint'] = 'Delete Google-imported unavailabilities in Easy!Appointments, remove leftover “Unavailable” blockers from Google, and import real busy time again. Bookings and manual unavailabilities stay.';
$lang['copy'] = 'Copy';
$lang['copied_to_clipboard'] = 'Copied to clipboard';
$lang['google_reset_unavailabilities_info'] = 'If the calendar shows duplicate “Unavailable” blocks, use Reset & re-sync for that provider. This removes leftover “Unavailable” events that an older sync wrote into Google, deletes Google-imported absences in Easy!Appointments, and imports real busy time fresh. Bookings and manual unavailabilities stay.';
$lang['google_reset_unavailabilities_confirm'] = 'Reset Google busy blocks for “{provider}”? This deletes {count} Google-imported unavailability block(s) in Easy!Appointments, removes leftover “Unavailable” events from Google Calendar, then re-syncs. Bookings and manual unavailabilities are kept.';
$lang['google_unavailabilities_reset_success'] = 'Deleted {deleted} local Google-imported block(s) and {google_deleted} leftover Google “Unavailable” event(s), then re-synced successfully.';
