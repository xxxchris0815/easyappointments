...
$lang['google_reset_unavailabilities_hint'] = 'Delete Google-imported unavailabilities in Easy!Appointments and import them again from Google. Bookings and manual unavailabilities stay.';
$lang['google_reset_unavailabilities_info'] = 'If the calendar shows duplicate “Unavailable” blocks, use Reset & re-sync for that provider. This deletes only Google-imported absences in Easy!Appointments and imports them fresh. Google Calendar itself is not changed.';
$lang['google_reset_unavailabilities_confirm'] = 'Delete {count} Google-imported unavailability block(s) for “{provider}” in Easy!Appointments and re-sync from Google? Bookings and manual unavailabilities are kept. Google Calendar is not changed.';
$lang['google_unavailabilities_reset_success'] = 'Deleted {deleted} Google-imported unavailability block(s) and re-synced successfully.';
