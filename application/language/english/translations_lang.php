...
$lang['google_sync_window_info'] = 'Google events only import inside each provider’s Sync Window (past/future days). Raise future days (e.g. 90) if late October or November busy blocks are missing, then Reset & re-sync. Diagnose uses that same window.';
...
$lang['sync_period_hint'] = 'How far Google/CalDAV events are imported as busy time. Raise future days (e.g. 90) if later months are missing after sync. Then use Reset & re-sync on the Google Sync Status page.';
