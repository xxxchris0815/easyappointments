...
$lang['provider_service_calendar_free_busy'] = 'Providers See Service Free/Busy Across All Providers';
$lang['provider_service_calendar_free_busy_hint'] = 'When enabled: In the calendar, choose Filter → Service (not Provider). Providers then see combined free/busy for everyone offering that service. Other providers’ appointments and blockers appear as anonymized “Busy” blocks (no customer names). The provider filter still shows only their own calendar.';
$lang['jitsi'] = 'Jitsi';
...
$lang['google_calendar_info'] = 'Enable Google Calendar synchronization: Easy!Appointments bookings are pushed to Google, and other Google events are imported as blocked time in Easy!Appointments.';
$lang['google_calendar_sync_status'] = 'Google Calendar Sync Status';
$lang['google_calendar_sync_status_info'] = 'See which providers have Google Calendar sync enabled, whether they are connected, and inspect recent Google sync log lines.';
$lang['google_calendar_sync_feature_disabled_hint'] = 'The global Google Calendar sync feature is currently disabled. Enable it under Integrations → Google Calendar.';
...
$lang['google_reset_unavailabilities'] = 'Reset & re-sync';
$lang['google_diagnose_unavailabilities'] = 'Diagnose';
$lang['google_diagnose_unavailabilities_hint'] = 'Export unavailability rows and duplicate groups for this provider (JSON). Window = that provider’s sync period (sync_past_days / sync_future_days).';
$lang['google_diagnose_ready'] = 'Diagnosis ready — copy the JSON below and send it for debugging.';
$lang['google_sync_logs_empty_hint'] = 'Only ERROR lines are stored with the default log_threshold. After Reset/Sync you should see “Google Sync Audit …” lines here. If still empty, use Diagnose and send the JSON.';
$lang['google_reset_unavailabilities_hint'] = 'Removes duplicate busy blocks (including manual double-imports), leftover Google “Unavailable” events, Google-imported absences, then re-syncs real busy time. Unique manual notes are kept.';
$lang['copy'] = 'Copy';
$lang['copied_to_clipboard'] = 'Copied to clipboard';
$lang['google_reset_unavailabilities_info'] = 'Duplicate “Unavailable” blocks are often manual leftovers from an old double import (no Google id), not live Google sync. Reset & re-sync now dedupes those exact/nested blank manuals, cleans Google leftovers, and re-imports real busy time.';
$lang['google_sync_window_info'] = 'Google events only import inside the Sync Window. Set it globally under Integrations → Google Calendar (applies to all providers), or override one provider under Providers. Then Reset & re-sync. Diagnose uses that same window.';
$lang['google_reset_unavailabilities_confirm'] = 'Reset busy blocks for “{provider}”? This removes duplicate blank manuals, leftover Google “Unavailable” events, and {count} Google-imported blocks, then re-syncs. Unique notes are kept.';
$lang['google_unavailabilities_reset_success'] = 'Cleanup done: {exact} exact duplicates, {nested} nested manuals, {deleted} Google imports, {google_deleted} Google “Unavailable” leftovers — then re-synced.';
$lang['sync_period'] = 'Sync Window';
$lang['sync_past_days'] = 'Sync Past Days';
$lang['sync_future_days'] = 'Sync Future Days';
$lang['sync_period_hint'] = 'Optional override for this provider only. The shared default is under Integrations → Google Calendar → Sync Window (saving there updates all providers). After changing, use Reset & re-sync on the Google Sync Status page.';
$lang['google_sync_window_global_hint'] = 'Shared import horizon for all providers (Google and CalDAV busy blocks). Saving applies these values to every provider. Raise future days (e.g. 90) if later months are missing after sync, then open Sync status → Reset & re-sync.';
...
$lang['google_calendar_anonymize_hint'] = 'When enabled globally, titles and details of events imported from Google Calendar are hidden in Easy!Appointments (only busy time is shown).';
$lang['provider_google_calendar_anonymize_hint'] = 'When enabled for this provider, titles and details of events imported from their Google Calendar are hidden in Easy!Appointments (only busy time is shown).';
$lang['secretary_restricted_view'] = 'Secretary Restricted View';
$lang['secretary_restricted_view_hint'] = 'When enabled, secretaries can edit/delete only appointments they created. In the calendar, secretaries always see only their own Easy!Appointments bookings in full; other bookings appear as busy blocks. Admins and the assigned provider always see full details.';
$lang['busy'] = 'Busy';
$lang['time_blocked'] = 'Time blocked';
$lang['time_available'] = 'Time available';
$lang['appointment_slot_free'] = 'Slot free';
$lang['appointment_slot_not_free'] = 'Slot not free';
...
$lang['booking_skip_confirmation_step_hint'] = 'Skip the booking confirmation step and submit directly to the success screen. CAPTCHA/ALTCHA on the confirmation step is automatically bypassed when this option is enabled.';
