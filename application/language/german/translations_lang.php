...
$lang['google_reset_unavailabilities_hint'] = 'Löscht die aus Google importierten Abwesenheiten in Easy!Appointments und importiert sie erneut. Buchungen und manuelle Abwesenheiten bleiben erhalten.';
$lang['google_reset_unavailabilities_info'] = 'Wenn im Kalender doppelte „Nichtverfügbarkeit“-Blöcke liegen, nutzen Sie „Zurücksetzen & neu syncen“ für den Anbieter. Es werden nur aus Google importierte Abwesenheiten in Easy!Appointments gelöscht und frisch importiert. Der Google-Kalender selbst bleibt unverändert.';
$lang['google_reset_unavailabilities_confirm'] = '{count} aus Google importierte Abwesenheitsblock(e) für „{provider}“ in Easy!Appointments löschen und neu aus Google synchronisieren? Buchungen und manuelle Abwesenheiten bleiben. Der Google-Kalender wird nicht geändert.';
$lang['google_unavailabilities_reset_success'] = '{deleted} aus Google importierte Abwesenheitsblock(e) gelöscht und erfolgreich neu synchronisiert.';
