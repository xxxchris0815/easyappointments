...
$lang['google_diagnose_unavailabilities_hint'] = 'Exportiert Abwesenheitszeilen und Duplikat-Gruppen für diesen Anbieter (JSON).';
...
$lang['google_reset_unavailabilities_hint'] = 'Löscht aus Google importierte Abwesenheiten in Easy!Appointments, entfernt übrig gebliebene „Unavailable“-Blocker in Google und importiert echte Busy-Zeiten neu. Buchungen und manuelle Abwesenheiten bleiben.';
$lang['copy'] = 'Kopieren';
$lang['copied_to_clipboard'] = 'In die Zwischenablage kopiert';
$lang['google_reset_unavailabilities_info'] = 'Wenn im Kalender doppelte „Nichtverfügbarkeit“-Blöcke liegen, nutzen Sie „Zurücksetzen & neu syncen“. Dabei werden alte „Unavailable“-Events entfernt, die ein früherer Sync nach Google geschrieben hat, die importierten Abwesenheiten in Easy!Appointments gelöscht und echte Busy-Zeiten neu importiert. Buchungen und manuelle Abwesenheiten bleiben.';
$lang['google_reset_unavailabilities_confirm'] = 'Google-Busy-Blöcke für „{provider}“ zurücksetzen? Es werden {count} importierte Abwesenheitsblock(e) in Easy!Appointments gelöscht, übrig gebliebene „Unavailable“-Events in Google entfernt und danach neu synchronisiert. Buchungen und manuelle Abwesenheiten bleiben.';
$lang['google_unavailabilities_reset_success'] = '{deleted} lokale Google-Import-Blöcke und {google_deleted} übrig gebliebene Google-„Unavailable“-Events gelöscht, danach erfolgreich neu synchronisiert.';
