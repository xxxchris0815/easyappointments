...
$lang['google_calendar_info'] = 'Enable Google Calendar synchronization to push Easy!Appointments bookings into provider Google Calendar accounts (one-way: EA → Google only).';
...
$lang['cleanup_google_unavailable'] = 'Delete “Unavailable” Google Events';
$lang['cleanup_google_unavailable_hint'] = 'Removes leftover Google Calendar events titled “Unavailable” in this provider’s sync window (from the old two-way sync). Real Easy!Appointments bookings are not deleted.';
$lang['cleanup_google_unavailable_prompt'] = 'Delete all Google Calendar events titled “Unavailable” for this provider? This cannot be undone.';
$lang['cleanup_google_unavailable_done'] = '$number “Unavailable” event(s) deleted from Google Calendar.';
$lang['cleanup_google_unavailable_none'] = 'No “Unavailable” events found in the sync window.';
$lang['cleanup_google_unavailable_sync_required'] = 'Select a provider with Google Calendar sync enabled first.';
