...
$lang['provider_service_calendar_free_busy_hint'] = 'When enabled: In the calendar under Filter → Service, a slot is available if at least one provider offering that service is free — even if you personally already have an appointment then. Gray only when nobody is free. The provider filter still shows only your own calendar.';
$lang['jitsi'] = 'Jitsi';
